...
public class ManagerController
{
	...
	{
		dbHelper.UpdateProduct(goods.ProductId, goods.CategoryId, goods.Name, goods.Manufacturer,
	...
	{
		dbHelper.UpdateCustomerCard(customer.CardNumber, customer.LastName, customer.FirstName, customer.PatronymicName,
			customer.PhoneNumber, customer.City, customer.Street, customer.Index, customer.Discount);
	}
...
/*public void CreateReceiptsPdf(List<ReceiptModel> receiptsList, string outputPath)
{
	...
	public void InsertCustomerCard(string cardNumber, string custSurname, string custName, string custPatronymic,
		string phoneNumber, string city, string street, string index, int percentage)
	{
